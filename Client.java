  ...
  public static void main(String[] args) {
    try {
      ...
      switch (args[0]) {
        case "new":
          if (args.length < 4) {
            System.out.println("Usage: new <userID> <itemName> <description> <reservePrice>");
            return;
          }
        ...
        case "register":
          ...
          System.out.println(
              registeredID != -1 ? "Registered successfully -> User ID: " + registeredID : "Registration failed.");
          break;

        default:
          System.out.println("Unknown command. Available commands: new, close, bid, list, register.");
          break;
      }
    } catch (Exception e) {
